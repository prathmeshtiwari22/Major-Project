...
const data = [
  { id: '1', title: 'BDA', description: 'Notes', image: require('../assets/images/bda.jpg'), slug: 'BDA', color: '#008000' },  // Green
  { id: '2', title: 'ML', description: 'Notes', image: require('../assets/images/ml.jpg'), slug: 'ML', color: '#FFA500' },   // Orange
  { id: '3', title: 'NLP', description: 'Notes', image: require('../assets/images/nlp.jpg'), slug: 'NLP', color: '#FF0000' },  // Red
  { id: '4', title: 'MIS', description: 'Notes', image: require('../assets/images/mis.jpg'), slug: 'MIS', color: '#FFC0CB' },  // Pink
  { id: '5', title: 'ARVR', description: 'Notes', image: require('../assets/images/arvr.jpg'), slug: 'ARVR', color: '#FFFF00' }, // Yellow
  { id: '6', title: 'DSA', description: 'Notes', image: require('../assets/images/dsa.jpg'), slug: 'DSA', color: '#EE82EE' },  // Violet
  { id: '7', title: 'C', description: 'Notes', image: require('../assets/images/c.jpg'), slug: 'C', color: '#808080' },  // Gray
  { id: '8', title: 'CPP', description: 'Notes', image: require('../assets/images/cplus.jpg'), slug: 'CPP', color: '#A52A2A' }, // Brown
  { id: '9', title: 'Python', description: 'Notes', image: require('../assets/images/python.jpg'), slug: 'Python', color: '#800000' }, // Maroon
];
...
const styles = StyleSheet.create({
  ...
  searchInput: {
    flex: 1,
    color: 'black',  // Text input color is black
    fontSize: 16,
    backgroundColor: '#FFFFFF',  // Ensure background is white for visibility
  },
  cardContainer: {
    marginBottom: 20,
    borderRadius: 10,
